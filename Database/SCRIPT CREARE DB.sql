...
--------------------------------------------------------
  CREATE UNIQUE INDEX "IONE"."DIAGNOSTICE__IDX" ON "IONE"."DIAGNOSTICE" ("PACIENTI_ID_PACIENT") 
 
--------------------------------------------------------
--  DDL for Index DIAGNOSTICE_PK
--------------------------------------------------------

  CREATE UNIQUE INDEX "IONE"."DIAGNOSTICE_PK" ON "IONE"."DIAGNOSTICE" ("ID_DIAGNOSTIC") 
...
--------------------------------------------------------
  ...
  ALTER TABLE "IONE"."PRETURI" MODIFY ("PRET_FARA_ABONAMENT" NOT NULL ENABLE);
  ALTER TABLE "IONE"."PRETURI" MODIFY ("PRET_CU_ABONAMENT" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "IONE"."DIAGNOSTICE" MODIFY ("PACIENTI_ID_PACIENT" NOT NULL ENABLE);
  ALTER TABLE "IONE"."DIAGNOSTICE" MODIFY ("DATA_DIAGNOSTIC" NOT NULL ENABLE);
  ALTER TABLE "IONE"."DIAGNOSTICE" MODIFY ("ID_DIAGNOSTIC" NOT NULL ENABLE);
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "IONE"."CONSULTATII" MODIFY ("PRETURI_ID_PRET" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "IONE"."DIAGNOSTICE" ADD CONSTRAINT "DIAGNOSTICE_PACIENTI_FK" FOREIGN KEY ("PACIENTI_ID_PACIENT")
...
--------------------------------------------------------
 ...
 ALTER TABLE "IONE"."CONSULTATII" ADD CONSTRAINT "CONSULTATII_PRETURI_FK" FOREIGN KEY ("PRETURI_ID_PRET")
