...
const DiseaseModal = ({ isOpen, children, onClose }) => {
    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center p-5 bg-black bg-opacity-50">
            <div className="relative w-full max-w-lg mx-auto bg-blue-300 rounded-2xl p-5 border-2 border-blue-600 overflow-auto max-h-full md:w-2/3 lg:w-1/2 xl:w-1/3">
