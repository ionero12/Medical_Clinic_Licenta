    ...
    return (
        <div className="border-white border rounded-lg text-right md:flex md:items-center md:justify-end">
            ...
            <div className={`md:flex ${isOpen ? 'block' : 'hidden'}`}>
                <Link to="medic/dashboard" className="text-white text-lg hover:underline block px-4 py-3 md:inline-block">Dashboard</Link>
                <Link to="/appointments" className="text-white text-lg hover:underline block px-4 py-3 md:inline-block">Appointments</Link>
                {/* Add more menu items as needed */}
                <Link to="medic/profile" className="text-white text-lg hover:underline block px-4 py-3 md:inline-block">Profile</Link>
                {/* Add more menu items as needed */}
            </div>
        </div>
    );
