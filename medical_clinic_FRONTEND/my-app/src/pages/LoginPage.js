        ...
        <div className="flex justify-center items-center min-h-screen min-w-screen">
            <div className="w-5/6 bg-white rounded overflow-hidden flex flex-row items-stretch shadow-lg">
                ...
                <div className="w-2/6 p-2 border border-black flex flex-col items-center justify-center">
                    ...
                    <p className="text-sm">
                        Nu aveti un cont? <a href={`/${userType}/register`} className="text-green-500">Inregistrati-va aici</a>
                    </p>
                        ...
                        {userType === 'pacient' && (
                            <>
                                <input type="text" placeholder="Email Pacient" value={emailPacient}
                                       onChange={e => setEmailPacient(e.target.value)} className="border border-gray-600 rounded p-2 mb-4 text-sm"/>
                                <input type="password" placeholder="Parola Pacient" value={parolaPacient}
                                       onChange={e => setParolaPacient(e.target.value)} className="border border-gray-600 rounded p-2 mb-4 text-sm"/>
                            </>
                        )}
